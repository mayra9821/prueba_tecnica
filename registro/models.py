...
class Ecorregion(models.Model):
    ...
    nombre = models.CharField(max_length=55, blank=True, null=True)
...
class RegistroBioEspecies(models.Model):
    ...
    especie = models.CharField(max_length=55, blank=True, null=True)
    familia = models.CharField(max_length=55, blank=True, null=True)
    nombre_comun = models.CharField(max_length=55, blank=True, null=True)
    proyecto = models.ForeignKey(Proyectos, models.DO_NOTHING, db_column='proyecto', blank=True, null=True)
    base_registro = models.CharField(max_length=55, blank=True, null=True, choices=CHOICES)
